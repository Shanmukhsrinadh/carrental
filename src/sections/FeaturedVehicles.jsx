    ...
    <section id="vehicles" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-14 gap-4">
          ...
          <button
            className="text-sm font-bold text-[#0F172A] border border-[#0F172A] hover:bg-[#0F172A] hover:text-white px-5 py-2.5 rounded-lg transition-colors self-start md:self-auto whitespace-nowrap"
